...
% Changes in Net C change under RCP8.5
%% CMIP6
...
save('Cnet11_ssp585_CMIP6_uncertRobut.mat')
%load('Cnet11_ssp585_CMIP6_uncertRobut.mat')
length(find(R_Cnet>=0.6))
length(find(frac_sig_Cnet>0 & frac_sig_Cnet<=0.2))

mapR06_Cnet(1:360,1:180) = NaN;  % agree on significant change 0.5
...
map4_Cnet85(1:360,1:180) = NaN;  % others
...
New_Cnet85_cmip6(1:180,1:360) = NaN;
...
New_map4_Cnet(:,1:180) = map4_Cnet85(:,181:360);
New_map4_Cnet(:,181:360) = map4_Cnet85(:,1:180);

New_Cnet85_cmip6(:,1:180) = sp6_reCnet_M11(:,181:360);
New_Cnet85_cmip6(:,181:360) = sp6_reCnet_M11(:,1:180);
...
figure
imshow(New_mapR06_Cnet)
figure 
imshow(New_frac_sig_Cnet)

csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Cnet\mapR1_0.6_85.csv',New_mapR06_Cnet);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Cnet\mapR1_0.8_85.csv',New_mapR08_Cnet);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Cnet\map2_frac02_85.csv',New_mapfrac02_Cnet);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Cnet\map3_frac05_r02_85.csv',New_mapfrac05_r02_Cnet);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Cnet\Cnet11_85_cmip6.csv',New_Cnet85_cmip6);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Cnet\map4Other_Cnet_85.csv',New_map4_Cnet);

csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Cnet\Rindex_Cnet85_cmip6.csv',New_R_Cnet);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Cnet\Fraction_Cnet85_cmip6.csv',New_frac_sig_Cnet);
