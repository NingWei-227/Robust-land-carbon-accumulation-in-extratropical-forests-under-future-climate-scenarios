...
% CMIP6
% changes in Rh under the ssp245
%% ssp245
load('Rh_cmip6_585.mat')

% for the estimation of A2
% calculating the multi-model mean value of the historical RH (OVER 1986-2005)
...
%% test whether the changes in RH is significant or not
...
save('RH11_ssp585_CMIP6_uncertRobut.mat')
%load('RH11_ssp585_CMIP6_uncertRobut.mat')

mapR06_rh85(1:360,1:180) = NaN;  % agree on significant change 0.5
mapR08_rh85(1:360,1:180) = NaN; % agree on significant change 0.8
mapfrac02_rh85(1:360,1:180) = NaN;  % agree on no change
mapfrac05_rh85(1:360,1:180) = NaN;  % inconsistent change
map4_rh85(1:360,1:180) = NaN;  % others
    ...
    for j=1:180
        ...
        if isnan(R_RH(i,j)) ==0 | isnan(frac_sig_RH(i,j)) ==0
            ...
            elseif frac_sig_RH(i,j)<= 0.2 && frac_sig_RH(i,j)>0
                mapfrac02_rh85(i,j) = 2;
            
            elseif R_RH(i,j)<0.2 && frac_sig_RH(i,j)> 0.5
                mapfrac05_rh85(i,j) = 3;
            else
                map4_rh85(i,j) = 4;
            end
...
mapR06_rh85 = mapR06_rh85.*mask;
mapR08_rh85 = mapR08_rh85.*mask;
mapfrac02_rh85 = mapfrac02_rh85.*mask;
mapfrac05_rh85 = mapfrac05_rh85.*mask;
map4_rh85 = map4_rh85.*mask;
sp6_RHnet_M11 = sp6_RHnet_M11.*mask; 
R_RH = R_RH.*mask;
frac_sig_RH = frac_sig_RH.*mask;

a = length(find(mapR06_rh85==1))
b = length(find(mapfrac02_rh85==2))
c = length(find(mapfrac05_rh85==3))
d = length(find(map4_rh85==4))
e = length(find(mapR08_rh85==1))

% change above map to match with global map
mapR06_rh85 = rot90(mapR06_rh85);
mapR08_rh85 = rot90(mapR08_rh85);
mapfrac02_rh85 = rot90(mapfrac02_rh85);
mapfrac05_rh85 = rot90(mapfrac05_rh85);
map4_rh85 = rot90(map4_rh85);
...
New_RHnet_sp85(1:180,1:360) = NaN;
New_R_RH(1:180,1:360) = NaN;
New_frac_sig_RH(1:180,1:360) = NaN;

New_mapR06_rh(:,1:180) = mapR06_rh85(:,181:360);
New_mapR06_rh(:,181:360) = mapR06_rh85(:,1:180);

New_mapR08_rh(:,1:180) = mapR08_rh85(:,181:360);
New_mapR08_rh(:,181:360) = mapR08_rh85(:,1:180);

New_mapfrac02_rh(:,1:180) = mapfrac02_rh85(:,181:360);
New_mapfrac02_rh(:,181:360) = mapfrac02_rh85(:,1:180);

New_mapfrac05_rh(:,1:180) = mapfrac05_rh85(:,181:360);
New_mapfrac05_rh(:,181:360) = mapfrac05_rh85(:,1:180);

New_map4_rh(:,1:180) = map4_rh85(:,181:360);
New_map4_rh(:,181:360) = map4_rh85(:,1:180);

New_RHnet_sp85(:,1:180) = sp6_reRHnet_M11(:,181:360);
New_RHnet_sp85(:,181:360) = sp6_reRHnet_M11(:,1:180);
...
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Rh\map1_0.6_rh.csv',New_mapR06_rh);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Rh\map11_0.8_rh.csv',New_mapR08_rh);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Rh\mapfrac02_rh.csv',New_mapfrac02_rh);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Rh\mapfrac05_rh.csv',New_mapfrac05_rh);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Rh\RHnet_cmip6.csv',New_RHnet_sp85);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Rh\mapOther_RH_cmip6.csv',New_map4_rh);

csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Rh\R_RHnet85_cmip6.csv',New_R_RH);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp5-5.8\Rh\Fraction_RHnet85_cmip6.csv',New_frac_sig_RH);
