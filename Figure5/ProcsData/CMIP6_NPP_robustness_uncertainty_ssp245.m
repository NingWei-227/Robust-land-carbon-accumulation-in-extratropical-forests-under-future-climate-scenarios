...
% CMIP6
% changes in NPP under the ssp245
%% ssp245
...
%save('NPP11_ssp245_CMIP6_uncertRobut.mat')
%load NPP11_ssp245_CMIP6_uncertRobut.mat

mapR06_npp45(1:360,1:180) = NaN;  % agree on significant change 0.5
mapR08_npp45(1:360,1:180) = NaN; % agree on significant change 0.8
mapfrac02_npp45(1:360,1:180) = NaN;  % agree on no change
mapfrac05_npp45(1:360,1:180) = NaN;  % inconsistent change
map4_npp45(1:360,1:180) = NaN;  % others
    ...
    for j=1:180
        ...
        if isnan(R_npp(i,j)) ==0 | isnan(frac_sig_NPP(i,j)) ==0
            ...
            elseif frac_sig_NPP(i,j)<= 0.2 && frac_sig_NPP(i,j)>0
                mapfrac02_npp45(i,j) = 2;
            
            elseif R_npp(i,j)<0.2 && frac_sig_NPP(i,j)> 0.5
                mapfrac05_npp45(i,j) = 3;
            else
                map4_npp45(i,j) = 4;
            end
...
mapR06_npp45 = mapR06_npp45.*mask;
mapR08_npp45 = mapR08_npp45.*mask;
mapfrac02_npp45 = mapfrac02_npp45.*mask;
mapfrac05_npp45 = mapfrac05_npp45.*mask;
map4_npp45 = map4_npp45.*mask;
sp6_NPPnet_M11 = sp6_NPPnet_M11.*mask; 
R_npp = R_npp.*mask;
frac_sig_NPP = frac_sig_NPP.*mask;

a = length(find(mapR06_npp45==1))
b = length(find(mapfrac02_npp45==2))
c = length(find(mapfrac05_npp45==3))
d = length(find(map4_npp45==4))
e = length(find(mapR08_npp45==1))

% change above map to match with global map
mapR06_npp45 = rot90(mapR06_npp45);
mapR08_npp45 = rot90(mapR08_npp45);
mapfrac02_npp45 = rot90(mapfrac02_npp45);
mapfrac05_npp45 = rot90(mapfrac05_npp45);
map4_npp45 = rot90(map4_npp45);
...
New_NPPnet_sp45(1:180,1:360) = NaN;
New_R_npp(1:180,1:360) = NaN;
New_frac_sig_NPP(1:180,1:360) = NaN;

New_mapR06_npp(:,1:180) = mapR06_npp45(:,181:360);
New_mapR06_npp(:,181:360) = mapR06_npp45(:,1:180);

New_mapR08_npp(:,1:180) = mapR08_npp45(:,181:360);
New_mapR08_npp(:,181:360) = mapR08_npp45(:,1:180);

New_mapfrac02_npp(:,1:180) = mapfrac02_npp45(:,181:360);
New_mapfrac02_npp(:,181:360) = mapfrac02_npp45(:,1:180);

New_mapfrac05_npp(:,1:180) = mapfrac05_npp45(:,181:360);
New_mapfrac05_npp(:,181:360) = mapfrac05_npp45(:,1:180);

New_map4_npp(:,1:180) = map4_npp45(:,181:360);
New_map4_npp(:,181:360) = map4_npp45(:,1:180);

New_NPPnet_sp45(:,1:180) = sp6_reNPPnet_M11(:,181:360);
New_NPPnet_sp45(:,181:360) = sp6_reNPPnet_M11(:,1:180);
...
figure
imshow(New_mapfrac05_npp)
figure
imshow(New_frac_sig_NPP)

csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp2-4.5\NPP\map1_0.6_npp.csv',New_mapR06_npp);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp2-4.5\NPP\map11_0.8_npp.csv',New_mapR08_npp);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp2-4.5\NPP\mapfrac02_npp.csv',New_mapfrac02_npp);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp2-4.5\NPP\mapfrac05_npp.csv',New_mapfrac05_npp);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp2-4.5\NPP\NPPnet_cmip6.csv',New_NPPnet_sp45);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp2-4.5\NPP\mapOther_NPP_45.csv',New_map4_npp);

csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp2-4.5\NPP\R_NPPnet45_cmip6.csv',New_R_npp);
csvwrite('E:\1_Mycase\4_NetC_Robustness_cmip6\writing\2_Codes_matdata\ssp2-4.5\NPP\Fraction_NPPnet45_cmip6.csv',New_frac_sig_NPP);
